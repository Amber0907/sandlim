...
<!-- <video src="../resources/img/about.mp4" controls autoplay muted loop></video> -->
    ...
    <div class="container">
        ...
        <div class="about">
<p>이리저리 돌아다니며 찾아오는 소나기처럼 변화무쌍한 삶 속에서도 잠시나마 쉼을 선사합니다.</p>
<p>생활 속에 스며들어있는 전 세계의 커피 문화를 일상을 풍요롭게 하는 제3의 공간으로서</p>
<p>국내에서도 지역사회 속에서 고객과 함께하며 산들림의 새로운 커피문화를 정착시키고 있습니다.</p>
        </div>
    </div>
    <div class="container">
       <div>
